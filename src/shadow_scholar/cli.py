...
CONTEXT_SETTINGS = dict(help_option_names=["-h", "--help"], default_map={})


@click.group(name="shadow-scholar", context_settings=CONTEXT_SETTINGS)
@click.option(
    "--aws-access-key-id",
    default=None,
...
@click.option(
    "--aws-region-name", default=None, help="AWS region name for boto3 client"
)
@click.pass_context
def cli(
    ctx: click.Context,
